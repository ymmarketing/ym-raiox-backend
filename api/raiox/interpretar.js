 ...
 * Body: { packet, responses, ref }
 * Resp: { ok:true, interpretation } | { ok:false, error }
 *
 * RX_REPORT_1.1: interpreta o packet canônico sem rediagnosticar.
 */
...
export default async function handler(req, res) {
  ...
  if (!Array.isArray(responses) || responses.length < 20 || !responses.every(responseShapeOk)) {
